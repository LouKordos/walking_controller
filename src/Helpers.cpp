...
Eigen::Matrix<double, 4, 1> get_joint_torques(Eigen::Matrix<double, 3, 1> f, double theta2, double theta3, double theta4, double theta5, double phi, double theta, double psi, leg_config &config) {
    return (Eigen::Matrix<double, 4, 1>() << f(0, 0)*((sin(phi)*sin(psi) + sin(theta)*cos(phi)*cos(psi))*(config.l3_x*cos(theta2) + config.l3_z*sin(theta2) + config.l4_x*cos(theta2) + config.l4_y*sin(theta2)*sin(theta3) + config.l4_z*sin(theta2)*cos(theta3) + config.l5_x*cos(theta2) + config.l5_y*sin(theta2)*sin(theta3 + theta4) + config.l5_z*sin(theta2)*cos(theta3 + theta4) + config.l6_x*cos(theta2) + config.l6_y*sin(theta2)*sin(theta3 + theta4 + theta5) + config.l6_z*sin(theta2)*cos(theta3 + theta4 + theta5)) - (-config.l3_x*sin(theta2) + config.l3_z*cos(theta2) - config.l4_x*sin(theta2) + config.l4_y*sin(theta3)*cos(theta2) + config.l4_z*cos(theta2)*cos(theta3) - config.l5_x*sin(theta2) + config.l5_y*sin(theta3 + theta4)*cos(theta2) + config.l5_z*cos(theta2)*cos(theta3 + theta4) - config.l6_x*sin(theta2) + config.l6_y*sin(theta3 + theta4 + theta5)*cos(theta2) + config.l6_z*cos(theta2)*cos(theta3 + theta4 + theta5))*cos(psi)*cos(theta)) - f(1, 0)*((sin(phi)*cos(psi) - sin(psi)*sin(theta)*cos(phi))*(config.l3_x*cos(theta2) + config.l3_z*sin(theta2) + config.l4_x*cos(theta2) + config.l4_y*sin(theta2)*sin(theta3) + config.l4_z*sin(theta2)*cos(theta3) + config.l5_x*cos(theta2) + config.l5_y*sin(theta2)*sin(theta3 + theta4) + config.l5_z*sin(theta2)*cos(theta3 + theta4) + config.l6_x*cos(theta2) + config.l6_y*sin(theta2)*sin(theta3 + theta4 + theta5) + config.l6_z*sin(theta2)*cos(theta3 + theta4 + theta5)) + (-config.l3_x*sin(theta2) + config.l3_z*cos(theta2) - config.l4_x*sin(theta2) + config.l4_y*sin(theta3)*cos(theta2) + config.l4_z*cos(theta2)*cos(theta3) - config.l5_x*sin(theta2) + config.l5_y*sin(theta3 + theta4)*cos(theta2) + config.l5_z*cos(theta2)*cos(theta3 + theta4) - config.l6_x*sin(theta2) + config.l6_y*sin(theta3 + theta4 + theta5)*cos(theta2) + config.l6_z*cos(theta2)*cos(theta3 + theta4 + theta5))*sin(psi)*cos(theta)) + f(2, 0)*((-config.l3_x*sin(theta2) + config.l3_z*cos(theta2) - config.l4_x*sin(theta2) + config.l4_y*sin(theta3)*cos(theta2) + config.l4_z*cos(theta2)*cos(theta3) - config.l5_x*sin(theta2) + config.l5_y*sin(theta3 + theta4)*cos(theta2) + config.l5_z*cos(theta2)*cos(theta3 + theta4) - config.l6_x*sin(theta2) + config.l6_y*sin(theta3 + theta4 + theta5)*cos(theta2) + config.l6_z*cos(theta2)*cos(theta3 + theta4 + theta5))*sin(theta) + (config.l3_x*cos(theta2) + config.l3_z*sin(theta2) + config.l4_x*cos(theta2) + config.l4_y*sin(theta2)*sin(theta3) + config.l4_z*sin(theta2)*cos(theta3) + config.l5_x*cos(theta2) + config.l5_y*sin(theta2)*sin(theta3 + theta4) + config.l5_z*sin(theta2)*cos(theta3 + theta4) + config.l6_x*cos(theta2) + config.l6_y*sin(theta2)*sin(theta3 + theta4 + theta5) + config.l6_z*sin(theta2)*cos(theta3 + theta4 + theta5))*cos(phi)*cos(theta)), -f(0, 0)*((sin(phi)*sin(psi) + sin(theta)*cos(phi)*cos(psi))*(config.l4_y*cos(theta3) - config.l4_z*sin(theta3) + config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*cos(theta2) - (sin(phi)*sin(theta)*cos(psi) - sin(psi)*cos(phi))*(config.l4_y*sin(theta3) + config.l4_z*cos(theta3) + config.l5_y*sin(theta3 + theta4) + config.l5_z*cos(theta3 + theta4) + config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5)) + (config.l4_y*cos(theta3) - config.l4_z*sin(theta3) + config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(theta2)*cos(psi)*cos(theta)) + f(1, 0)*((sin(phi)*cos(psi) - sin(psi)*sin(theta)*cos(phi))*(config.l4_y*cos(theta3) - config.l4_z*sin(theta3) + config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*cos(theta2) + (sin(phi)*sin(psi)*sin(theta) + cos(phi)*cos(psi))*(config.l4_y*sin(theta3) + config.l4_z*cos(theta3) + config.l5_y*sin(theta3 + theta4) + config.l5_z*cos(theta3 + theta4) + config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5)) - (config.l4_y*cos(theta3) - config.l4_z*sin(theta3) + config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(psi)*sin(theta2)*cos(theta)) + f(2, 0)*((config.l4_y*sin(theta3) + config.l4_z*cos(theta3) + config.l5_y*sin(theta3 + theta4) + config.l5_z*cos(theta3 + theta4) + config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5))*sin(phi)*cos(theta) + (config.l4_y*cos(theta3) - config.l4_z*sin(theta3) + config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(theta)*sin(theta2) - (config.l4_y*cos(theta3) - config.l4_z*sin(theta3) + config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*cos(phi)*cos(theta)*cos(theta2)), -f(0, 0)*((sin(phi)*sin(psi) + sin(theta)*cos(phi)*cos(psi))*(config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*cos(theta2) - (sin(phi)*sin(theta)*cos(psi) - sin(psi)*cos(phi))*(config.l5_y*sin(theta3 + theta4) + config.l5_z*cos(theta3 + theta4) + config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5)) + (config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(theta2)*cos(psi)*cos(theta)) + f(1, 0)*((sin(phi)*cos(psi) - sin(psi)*sin(theta)*cos(phi))*(config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*cos(theta2) + (sin(phi)*sin(psi)*sin(theta) + cos(phi)*cos(psi))*(config.l5_y*sin(theta3 + theta4) + config.l5_z*cos(theta3 + theta4) + config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5)) - (config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(psi)*sin(theta2)*cos(theta)) + f(2, 0)*((config.l5_y*sin(theta3 + theta4) + config.l5_z*cos(theta3 + theta4) + config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5))*sin(phi)*cos(theta) + (config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(theta)*sin(theta2) - (config.l5_y*cos(theta3 + theta4) - config.l5_z*sin(theta3 + theta4) + config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*cos(phi)*cos(theta)*cos(theta2)), -f(0, 0)*(-(config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5))*(sin(phi)*sin(theta)*cos(psi) - sin(psi)*cos(phi)) + (config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*(sin(phi)*sin(psi) + sin(theta)*cos(phi)*cos(psi))*cos(theta2) + (config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(theta2)*cos(psi)*cos(theta)) + f(1, 0)*((config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5))*(sin(phi)*sin(psi)*sin(theta) + cos(phi)*cos(psi)) + (config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*(sin(phi)*cos(psi) - sin(psi)*sin(theta)*cos(phi))*cos(theta2) - (config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(psi)*sin(theta2)*cos(theta)) + f(2, 0)*((config.l6_y*sin(theta3 + theta4 + theta5) + config.l6_z*cos(theta3 + theta4 + theta5))*sin(phi)*cos(theta) + (config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*sin(theta)*sin(theta2) - (config.l6_y*cos(theta3 + theta4 + theta5) - config.l6_z*sin(theta3 + theta4 + theta5))*cos(phi)*cos(theta)*cos(theta2))).finished();
}
