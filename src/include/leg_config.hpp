...
struct leg_config {
    ...
    double Ixx_ul = 8.5e-04 * 10;
    double Ixy_ul = 0;
    double Ixz_ul = 0;

    double Iyx_ul = 0;
    double Iyy_ul = 8.5e-04 * 10;
    double Iyz_ul = 0;

    double Izx_ul = 0;
    double Izy_ul = 0;
    double Izz_ul = 1e-04 * 10;

    //"ll" is lower leg

    double Ixx_ll = 7.982e-04 * 10;
    double Ixy_ll = 0;
    double Ixz_ll = 0;

    double Iyx_ll = 0;
    double Iyy_ll = 7.982e-04 * 10;
    double Iyz_ll = 0;

    double Izx_ll = 0;
    double Izy_ll = 0;
    double Izz_ll = 9.378e-05 * 10;

    double Ixx_foot = 1.42e-04 * 2;
    double Ixy_foot = 0;
    double Ixz_foot = 0;

    double Iyx_foot = 0;
    double Iyy_foot = 2.8e-05 * 2;
    double Iyz_foot = 0;

    double Izx_foot = 0;
    double Izy_foot = 0;
    double Izz_foot = 1.6e-04 * 2;

    // Masses of each link in kg

    double m_hip3 = 0.1 * 10;
    double m_hip2 = 0.1 * 10;
    double m_hip1 = 0.1 * 10;
    double m_ul = 0.11 * 10;
    double m_ll = 0.1 * 10;
    double m_foot = 0.05 * 2;
